...
radius = 1000.0
n_estimators = 20
exp_name = 't_rh_1000km'
exp_type = 'station_radius'
...
df_stats = pd.DataFrame(index=columns, columns=['mean', 'std', 'max', 'pct95', 'mean_distance', 'n_stations', 'time'])
