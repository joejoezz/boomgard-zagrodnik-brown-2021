...
df_combined = pd.concat((df_tmax, df_wspd, df_wdir, df_rh, df_solar), axis=1)
...
for column in columns:
    ...
    if np.isnan(df_stats['mean'][column]) == False:
        ...
        X = df_simple.drop(columns=[column, column_wspd, column_wdir, column_rh, column_solar])
